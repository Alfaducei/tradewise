...
from config import get_skills_dir, get_backup_dir, BACKUP_RETENTION_DAYS
...
def update_skill(change: Dict[str, Any]) -> bool:
    ...
    skill_path = get_skills_dir() / skill_name / 'SKILL.md'
...
def cleanup_old_backups(backup_dir: Path, days: int = None):
